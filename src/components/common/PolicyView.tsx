...
export default function PolicyView({ type }: PolicyViewProps) {
  const content = {
    privacy: {
      ...
      sections: [
        {
          heading: '1. Boonava Information Security Creed',
        ...
        },
        {
          ...
          text: 'By joining our Boonava newsletter circle, you allow us to securely record your email address to transfer travel vouchers and notification alerts about upcoming botanical drops. You may instantly click "Opt-Out" at the base of any newsletter to completely bleach your parameters from our lists.',
        },
      ],
    },
    terms: {
      ...
      sections: [
        {
          ...
          text: 'All Boonava soap washes contain genuine natural active components (including cold-pressed sweet orange peel oils, absolute neroli molecules, and organic citric acids). If you suffer from known allergies to citrus seeds or plants, we recommend reviewing our published ingredients or performing a 24-hour localized wrist skin test prior to global coverage.',
        },
        {
          heading: '2. Dispatch and Carrier Responsibility',
          text: 'We package each luxury bottle inside highly resilient custom boxes or reinforced post-consumer card cases. Standard delivery transitions are handled by carbon-neutral logistics partners. Boonava takes full responsibility for any bottle shattering during transit.',
        },
        {
          heading: '3. Digital Store Accuracy',
          text: 'We strive to maintain exact visual representation of our products. Due to the high purity and seasonal hand-harvest nature of our ingredients, minor variations in the amber visual color spectrum of the washes are normal and reflect organic authenticity.',
        },
      ],
    },
    return: {
      title: 'Luminous Returns & Guarantees',
      subtitle: 'The Boonava Happiness Guarantee',
      ...
      sections: [
        {
          ...
          text: 'Because every skin profile behaves differently under citrus fruit enzymes, we provide our acclaimed 30-Day Luminous Guarantee. If any of our face or body cleansers fails to upgrade your glow, triggers tight dryness, or causes flushing, we back you up 100%.',
        },
        {
          heading: '2. Returns Process on Opened Containers',
          text: 'We accept returns on bottles even if they are already opened, unsealed, or partly used. Reach out to our Bespoke Care Lab at boonavacare@gmail.com to secure a pre-paid shipping label. Wrap your amber glass bottle safely and drop it at any standard shipping carrier.',
        },
        {
          heading: '3. Refund Issuance Duration',
          text: 'Upon product arrival at our central warehouse in Tumkur, our chemists inspect the container, and our systems issue a 100% full refund immediately. Refund timelines take 2 to 5 standard bank business days to reflect on your payment method.',
        },
      ],
    },
  };
    ...
    <div className="bg-[#FAF8F5] pb-24 text-left">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        ...
        <p className="text-stone-600 text-xs font-light leading-relaxed mb-10 pb-6 border-b border-stone-200">
          The Boonava Care corporation values regulatory transparency and cosmetic safety. Please read these legal covenants detailing product warranties, shipping protections, and user parameter processing before finalizing purchases from our store.
        </p>
